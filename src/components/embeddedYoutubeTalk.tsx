...
export default function EmbeddedYoutubeTalk(): JSX.Element {
  return (
    <>
      ...
      <div style={{ marginRight: 150, marginLeft: 150, marginBottom: 100 }}>
        <Carousel infiniteLoop={true} dynamicHeight={true} showThumbs={false}>
          <div>
            <Youtube videoId="atTMl-FyQJk" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="0GpmjkRFbXI" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="tVY_DmHuw74" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="vnBNi2nbqX0" opts={{ height: '600', width: '760' }} />
          </div>
        </Carousel>
      </div>
    </>
