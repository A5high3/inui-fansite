...
export default function EmbeddedYoutubeYozuri(): JSX.Element {
  return (
    <>
      ...
      <div style={{ marginRight: 150, marginLeft: 150, marginBottom: 100 }}>
        <Carousel infiniteLoop={true} dynamicHeight={true} showThumbs={false}>
          <div>
            <Youtube videoId="Y7jHkbmBFeI" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="KTp1ECYUuaM" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="kNgN_sXHg9o" opts={{ height: '600', width: '760' }} />
          </div>
          <div>
            <Youtube videoId="8oEQM5L0xYM" opts={{ height: '600', width: '760' }} />
          </div>
        </Carousel>
      </div>
    </>
